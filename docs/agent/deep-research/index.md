...
timeline
    ...
    2026 : O-Researcher（2026-01） : REDSearcher（小红书, 2026-02） : MiroFlow（MiroMind, 2026-02） : Marco DeepResearch（阿里国际, 2026-03） : Mind DeepResearch（理想, 2026-04） : AgentDisCo（解耦+协作, 2026-05） : DR-Rubric（深研造 RL 奖励, 2026-05） : QUEST（OSU NLP, 2026-05） : Co-ReAct（阿里通义+清华, 2026-05）
```
